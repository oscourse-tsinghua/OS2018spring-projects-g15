...
static s_root_busses: Mutex<Queue<Bus>> = Mutex::new(queue_init!());

/// List of registered drivers
#[allow(non_upper_case_globals)]
static s_driver_list: Mutex<Queue<&'static Driver>> = Mutex::new( queue_init!() );
